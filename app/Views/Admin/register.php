            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                        <div class="img" style="background-image: url(newassets/images/bg-1.jpg);">
                        </div>
                ...
                <?php endif;?>
                            <form action="<?php echo base_url(); ?>/UserController/store" method="post" class="signin-form">
                            <div class="form-group mb-3">
                                    <label class="label" for="name">Name</label>
                                    <input type="text" class="form-control" name="name" placeholder="Username" value="<?= set_value('name') ?>" required>
                                </div>
                                <div class="form-group mb-3">
